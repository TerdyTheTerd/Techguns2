...
public class TGuns implements ITGInitializer {
	...
	private static final float PENETRATION_LOW = 0.1f;
	private static final float PENETRATION_MED = .25f;
	private static final float PENETRATION_MED_HIGH = .5f;
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		IProjectileFactory<GenericProjectile> PIERCING_ROUNDS = new GenericProjectilePiercing.Factory(false);
		IProjectileFactory[] GENERIC_BULLET = {GENERIC_PROJECTILE, INCENDIARY_ROUNDS};
		IProjectileFactory[] SNIPER_ROUNDS = {GENERIC_PROJECTILE, INCENDIARY_ROUNDS, new GenericProjectileExplosive.Factory(), PIERCING_ROUNDS};
