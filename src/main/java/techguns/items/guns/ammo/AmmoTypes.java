...
public class AmmoTypes implements ITGInitializer{
	...
	public static final String TYPE_PIERCING = "piercing";
	...
	public void preInit(FMLPreInitializationEvent event) {
		...
		//RIFLE_ROUNDS.addVariant(TYPE_PIERCING, TGItems.RIFLE_ROUNDS_PIERCING);
		...
		//ASSAULT_RIFLE_MAGAZINE.addVariant(TYPE_PIERCING,TGItems.ASSAULTRIFLE_MAGAZINE_PIERCING, TGItems.RIFLE_ROUNDS_PIERCING);
		...
		AS50_MAGAZINE.addVariant(TYPE_PIERCING, TGItems.AS50_MAGAZINE_PIERCING, TGItems.SNIPER_ROUNDS_PIERCING);
